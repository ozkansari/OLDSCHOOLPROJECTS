 ...
 * java.security.MessageDigest. Use of this algorithm doesn't require any
 * additional nested <param>s. Supported <param>s are: <table>
 * <tr>
 * <th>name</th>
 * <th>values</th>
 * <th>description</th>
...
public class MD5Wrapper {
	...
	/**
	 * Specifies the algorithm to be used to compute the checksum. Defaults to
	 * "MD5". Other popular algorithms like "SHA" may be used as well.
	 * 
	 * @param algorithm
	...
	public boolean isValid() {
		return "SHA".equalsIgnoreCase(algorithm)
	...
	// hint
	public String getValue(File file) throws NoSuchAlgorithmException,
			NoSuchProviderException {
		initMessageDigest();
	...
	public String getValue(String buffer) throws NoSuchAlgorithmException,
			NoSuchProviderException {
		initMessageDigest();
		String checksum = null;
		try {
